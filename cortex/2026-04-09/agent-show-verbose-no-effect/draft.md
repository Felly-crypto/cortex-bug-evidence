...
2. Run cortex agent show demo --color never.
3. Run cortex --verbose agent show demo --color never.
4. Compare the two output blocks.

### Expected Behavior
The verbose run should include extra diagnostic detail beyond the default agent details.

### Actual Behavior
The verbose run prints the same visible agent details as the default run.
